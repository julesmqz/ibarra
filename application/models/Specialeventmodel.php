...
class Specialeventmodel extends CI_Model {
	
    public $title = null;
    public $description = null;
    public $date_created = null;
    protected $_itemsPerPage = 10;
    protected $_tableName = "special_event";
    ...
    public function get_entries( $number = 10)
    {
			...
			$this->db->join("image", "image.objectid = {$this->_tableName}.id and type='specialevent'","left");
    ...
    public function getList( $page = 0){
    	...
    	foreach ($entries as $entry) {
    		$res[] = ["id"=> $entry->id,"title" => $entry->title, "date_created"=> $entry->date_created,"dynamic_field_value" => $entry->totalImages,'url_edit' => base_url('specialevent/edit/'.$entry->id),'url_delete' => base_url('specialevent/delete/'.$entry->id)];
    	}
